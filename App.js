  ...
  return (
      <a href="/" className="res-card">
        <div className="res-card-image-container">
          <img className="res-card-image-container-logo" alt="res-card-image-container-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId}/>
        ...
        <div className="res-card-content">
          ...
          <div className="res-card-content-rating-deliverytime">
            <div className="res-card-content-rating-deliverytime-container">
            <div className="res-card-content-rating">
          ...
          <div className="res-card-content-cuisines">
            <p className="res-card-content-cuisines-text">{cuisines.join(", ")}</p>
          </div>
...
const resLists = [
  {
    ...
    "analytics": {
      "context": "seo-data-223e76c6-6553-49db-8fc5-b97d6baefa58"
    },
    "cta": {
  ...
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/lucky-multicuisine-restaurant-somajiguda-hyderabad-100942",
      "text": "RESTAURANT_MENU",
      "type": "WEBLINK"
    },
    "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
  },
  {
    ...
    "cta": {
      "link": "https://www.swiggy.com/restaurants/varalakshmi-tiffins-paradise-circle-ramgopalpet-hyderabad-575804",
      "text": "RESTAURANT_MENU",
      "type": "WEBLINK"
    },
    "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
  ...
  return (
    <div className="res-container">
      ...
      <div className="res-cards">
        {
          resLists.map(resList=> <ResCards key={resList.info.id} resData={resList}/>)
        }
      </div>
    </div>
  )
