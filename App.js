  ...
  return (
      <a href="/" className="res-card">
        <div className="res-card-image-container">
          <img className="res-card-image-container-logo" alt="res-card-image-container-logo" src={props.resimg}/>
          <div className="res-card-image-container-paracontainer">
          <p className="res-card-image-container-para"> ITEMS AT ₹149</p>
          </div>
        </div>
        <div className="res-card-content">
          ...
          <div className="res-card-content-cuisines">
            <p className="res-card-content-cuisines-text">{props.rescuisine}</p>
          </div>
          <div className="res-card-content-location">
            <p className="res-card-content-location-text">{props.resplace}</p>
          </div>
        </div>
      </a>
  )
...
const Body  = ()=>{
  return (
    <div className="res-container">
      ...
      <ResCards resname = "Chinese Work" rescuisine = "Chinese, Asian, Tibetian" resimg = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/e0839ff574213e6f35b3899ebf1fc597" resplace = "Gachibowli"/>
      <ResCards resname = "Wow! Momo" rescuisine = "Tibetian, Asian, Healthy Food" resimg = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/64fd45fd9f44c1737bc446e470bed666" resplace = "Himayath Nagar"/>
      </div>
    </div>
  )
}
